...
const CATEGORIES = [
  ...
  { value: "UI", label: "🎨 UI/Design", desc: "Visual or layout issues" },
  {
    ...
    desc: "About the news or memes",
  },
  {
    value: "PERFORMANCE",
    label: "⚡ Performance",
    desc: "App feels slow or laggy",
  },
      ...
      <div style={S.page}>
        ...
        <div style={S.header}>
          ...
          <div style={S.headerContent}>
            ...
            <p style={S.subheading}>Help us make SqueezeFeed better</p>
          </div>
        </div>
        ...
        {success ? (
          ...
          <div style={S.body}>
            ...
            <div style={S.categoryGrid}>
              {CATEGORIES.map((cat) => (
                ...
                >
                  ...
                  {category === cat.value && <div style={S.catCheck}>✓</div>}
                </div>
              ))}
            </div>
            ...
            <button
              ...
              disabled={loading}
            >
              {loading ? <span style={S.spinner} /> : "✦ Submit Feedback"}
            </button>
