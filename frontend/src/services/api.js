...
export const getByCategory = (category) => api.get(`/api/content/category/${category}`);
export const incrementShare = (id) => api.post(`/api/content/${id}/share`);

// Meme Feed
export const getMemes = () =>
    api.get('/api/content/memes');
...
export const saveArticle = (
    ...
    api.post(
        `/api/users/save/${authUserId}/${contentId}`
    );
...
export const trackProfileView = (
    ...
    api.post(
        `/api/users/track/profile-view/${profileOwnerId}/${viewerUserId}`
    );
...
export const trackProfileLike = (
    ...
    api.post(
        `/api/users/track/profile-like/${authUserId}`
    );
...
export const likePublicProfile = (
    profileOwnerId,
    likerUserId
) =>
    api.post(
        `/api/users/profile-like/${profileOwnerId}/${likerUserId}`
    );
