...
// ── Badge meta ───────────────────────────────────────────────
const BADGE_META = {
    NEWS_HUNTER_I:    { icon: "🥉", label: "Bronze",  color: "#cd7f32", glow: "rgba(205,127,50,0.5)"  },
    NEWS_HUNTER_II:   { icon: "🥈", label: "Silver",  color: "#c0c0c0", glow: "rgba(192,192,192,0.5)" },
    NEWS_HUNTER_III:  { icon: "🥇", label: "Gold",    color: "#FF6A00", glow: "rgba(255,106,0,0.5)"   },
    NEWS_HUNTER_IV:   { icon: "💎", label: "Diamond", color: "#7dd3fc", glow: "rgba(125,211,252,0.5)" },
    NEWS_HUNTER_V:    { icon: "👑", label: "Legend",  color: "#f9a8d4", glow: "rgba(249,168,212,0.5)" },
    SIGNAL_BOOSTER_I: { icon: "📡", label: "Signal",  color: "#FF6A00", glow: "rgba(255,106,0,0.4)"   },
    DEBATE_LORD_I:    { icon: "⚡", label: "Debate",  color: "#facc15", glow: "rgba(250,204,21,0.4)"   },
};

function getBadgeMeta(key) {
    return BADGE_META[key] || { icon: "🏆", label: "Badge", color: "#FF6A00", glow: "rgba(255,106,0,0.4)" };
}
...
const FRAME_DEFS = [
    {
        ...
        req: 0,
        color: "#888",
        miniStyle: { background: "#1a1a1a", border: "2px dashed rgba(255,106,0,0.5)" },
    ...
    },
    {
        ...
        req: 50,
        color: "#38bdf8",
        miniStyle: { background: "#050d14", border: "2px solid #38bdf8", boxShadow: "0 0 12px rgba(56,189,248,0.6)" },
    ...
    },
    {
        ...
        req: 200,
        color: "#FF6A00",
        miniStyle: { background: "#110800", border: "2px solid #FF6A00", boxShadow: "0 0 14px rgba(255,106,0,0.7)" },
        miniIconColor: "#FF6A00",
    },
    {
        key: "fire",
        ...
        req: 500,
        color: "#ff4500",
        miniStyle: { background: "linear-gradient(135deg,#ff4500,#ff8c00)", border: "none" },
        miniIconColor: "#fff",
    },
    {
        key: "galaxy",
        ...
        req: 1500,
        color: "#a78bfa",
        miniStyle: { background: "linear-gradient(135deg,#06021a,#1a0640)", border: "2px solid #7c3aed", boxShadow: "0 0 14px rgba(124,58,237,0.5)" },
...
function AvatarFrame({ frameKey }) {
    ...
    const online = (
        <div style={{
            ...
            boxShadow: "0 0 8px rgba(34,197,94,0.7)", zIndex: 5,
        }} />
    );

    if (frameKey === "blue_glow") return (
        <div style={{ position: "relative", width: 108, height: 108, display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            <div style={{ ...S.frameRing, inset: -8, border: "2px solid rgba(56,189,248,0.35)", animation: "blueRingSpin 6s linear infinite" }}>
                <div style={{ position: "absolute", width: 7, height: 7, borderRadius: "50%", background: "#38bdf8", boxShadow: "0 0 10px #38bdf8", top: -3.5, left: "calc(50% - 3.5px)" }} />
            </div>
            <div style={{ ...S.avatarCore, border: "2.5px solid #38bdf8", background: "#050d14", animation: "blueGlowPulse 2s ease-in-out infinite" }}>
                {avatarIcon("#38bdf8")}
            </div>
            {online}
        </div>
    ...
    if (frameKey === "orange_pulse") return (
        <div style={{ position: "relative", width: 108, height: 108, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <div style={{ ...S.frameRing, inset: -8, border: "2px solid rgba(255,106,0,0.4)", animation: "orangeRingSpin 4s linear infinite" }}>
                <div style={{ position: "absolute", width: 8, height: 8, borderRadius: "50%", background: "#FF6A00", boxShadow: "0 0 12px #FF6A00", top: -4, left: "calc(50% - 4px)" }} />
            </div>
            <div style={{ ...S.avatarCore, border: "2.5px solid #FF6A00", background: "#110800", animation: "orangePulseRing 1.8s ease-in-out infinite" }}>
                {avatarIcon("#FF6A00")}
            </div>
            {online}
        </div>
    ...
    if (frameKey === "fire") return (
        <div style={{ position: "relative", width: 108, height: 108, display: "flex", alignItems: "center", justifyContent: "center" }}>
            {/* Fire particles */}
            {[0,1,2,3].map(i => (
                <div key={i} style={{
                    position: "absolute", width: 5, height: 8, borderRadius: "50%",
                    background: "#ff6a00", bottom: -12, left: `${30 + i * 12}%`,
                    zIndex: 6, animation: `fireParticle ${0.6 + i * 0.15}s ease-out infinite`,
            ...
            <div style={{
                ...
                background: "linear-gradient(45deg,#ff4500,#FF6A00,#ffaa00,#ff4500)",
                backgroundSize: "300% 300%",
                animation: "fireBorder 1.5s ease infinite, fireFlicker 1.2s ease-in-out infinite",
                zIndex: 1,
            }}>
                <div style={{ position: "absolute", inset: 3, borderRadius: "50%", background: "#111", zIndex: 2 }} />
            </div>
    ...
    if (frameKey === "galaxy") return (
        <div style={{ position: "relative", width: 108, height: 108, display: "flex", alignItems: "center", justifyContent: "center" }}>
            {/* Galaxy gradient shell */}
            <div style={{
                position: "absolute", inset: -5, borderRadius: "50%",
                background: "linear-gradient(135deg,#7c3aed,#FF6A00,#06b6d4,#f9a8d4,#7c3aed)",
                backgroundSize: "300% 300%",
                animation: "fireBorder 3s ease infinite",
                zIndex: 1,
            }}>
                <div style={{ position: "absolute", inset: 3, borderRadius: "50%", background: "#06021a", zIndex: 2 }} />
            </div>
            {/* Orbit ring 1 */}
            <div style={{ ...S.frameRing, inset: -16, border: "1px solid rgba(167,139,250,0.2)", animation: "galaxyRotate 4s linear infinite", zIndex: 6 }}>
                <div style={{ position: "absolute", width: 8, height: 8, borderRadius: "50%", background: "#a78bfa", boxShadow: "0 0 10px #a78bfa", top: -4, left: "calc(50% - 4px)" }} />
            </div>
            {/* Orbit ring 2 */}
            <div style={{ ...S.frameRing, inset: -24, border: "1px solid rgba(6,182,212,0.15)", animation: "galaxyRotate 7s linear infinite reverse", zIndex: 6 }}>
                <div style={{ position: "absolute", width: 6, height: 6, borderRadius: "50%", background: "#06b6d4", boxShadow: "0 0 8px #06b6d4", bottom: -3, left: "calc(50% - 3px)" }} />
            </div>
    ...
    return (
        <div style={{ position: "relative", width: 108, height: 108, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <div style={{ ...S.frameRing, inset: -7, border: "2px dashed rgba(255,106,0,0.45)", animation: "defaultRingSpin 9s linear infinite" }} />
            <div style={{ ...S.frameRing, inset: -14, border: "1px dotted rgba(255,106,0,0.2)", animation: "defaultRingSpin 15s linear infinite reverse" }} />
            <div style={S.avatarCore}>
                {avatarIcon("#FF6A00")}
            </div>
            {online}
        </div>
...
function FrameCard({ def, articlesRead, currentFrame, autoFrame, onSelect }) {
    ...
    return (
        <div
            ...
            style={{
                ...S.frameCard,
                borderColor: isActive ? "rgba(255,106,0,0.5)" : "rgba(255,255,255,0.06)",
                background:  isActive ? "rgba(255,106,0,0.08)" : "rgba(255,255,255,0.02)",
        ...
        >
            ...
            <div style={{ flex: 1 }}>
                <div style={{ fontSize: 12, fontWeight: 700, color: "#fff", fontFamily: "'Space Grotesk', sans-serif" }}>
                    {def.label}
                </div>
                <div style={{ fontSize: 10, color: unlocked ? "#22c55e" : "#3a3a3a", marginTop: 2, letterSpacing: "0.04em" }}>
                    {unlocked ? "✓ Unlocked" : `🔒 ${def.req} articles`}
                </div>
            </div>

            {isActive && (
                <div style={S.activeBadge}>ON</div>
            )}
...
export default function ProfilePage() {
    ...
    useEffect(() => {
        ...
        axios.get(`${BASE_URL}/api/users/profile/${authUserId}`, {
            headers: { Authorization: `Bearer ${token}` },
        })
        .then((res) => {
            setProfile(res.data);
            const frame = res.data.currentFrame || resolveFrame(res.data.articlesRead || 0);
            ...
            badges.forEach((_, i) => {
                setTimeout(() => setVisibleBadges(prev => [...prev, i]), 100 + i * 80);
            });
        })
        .catch((err) => {
            console.error(err);
        ...
        <>
                ...
                onClaim={async () => {
                    ...
                    try {
                        ...
                        setProfile(prev => ({
                            ...
                            pendingBadges: prev.pendingBadges.filter(b => b !== activeBadge),
                        }));
                        setActiveBadge(null);
            ...
            <div style={S.page}>
                ...
                <div style={S.hero}>
                    ...
                    {/* Ambient particles */}
                    {[
                        { left:"12%", top:"65%", dx:"-18px", dy:"-45px", dur:"3.2s", del:".2s"  },
                        { left:"78%", top:"55%", dx:"14px",  dy:"-50px", dur:"2.8s", del:".8s"  },
                        { left:"42%", top:"82%", dx:"-8px",  dy:"-55px", dur:"3.5s", del:"1.3s" },
                        { left:"88%", top:"35%", dx:"10px",  dy:"-38px", dur:"2.6s", del:".5s"  },
                    ].map((p, i) => (
                        <div key={i} aria-hidden style={{
                            position:"absolute", width:3, height:3, borderRadius:"50%",
                            background:"#FF6A00", pointerEvents:"none",
                    ...
                    <div style={S.sfLogo}>
                        <SqueezeMark size={14} />
                        <span>Squeeze<span style={{ color:"#FF6A00" }}>Feed</span></span>
                    </div>

                    {/* Avatar with frame */}
                    <div style={{ animation:"floatAvatar 4s ease-in-out infinite", marginBottom:20 }}>
                    ...
                    <div style={S.framePill}>
                        ...
                        <span style={S.frameLabel}>
                            {FRAME_DEFS.find(f => f.key === currentFrame)?.label || "Default"}
                        </span>
                    </div>
                </div>
                ...
                <div style={S.statsRow}>
                    {[
                        ...
                        <div className="stat-col" key={s.l} style={{ ...S.statCol, animationDelay:`${0.05 + i * 0.05}s` }}>
                ...
                <div style={S.section}>
                    ...
                    {profile.badges?.length > 0 ? (
                                ...
                                return (
                                    <div
                                        ...
                                        style={{
                                            ...
                                            animation: visibleBadges.includes(i) ? "badgeIn 0.35s ease forwards" : "none",
                                            transition: "background 0.2s, transform 0.2s",
                                        }}
                                    >
                                        <div style={{ width:8, height:8, borderRadius:"50%", background:meta.color, boxShadow:`0 0 8px ${meta.glow}`, flexShrink:0, animation:"glowPulse 2s ease infinite" }} />
                                        <span style={{ fontSize:22, flexShrink:0 }}>{meta.icon}</span>
                                        <div style={{ flex:1 }}>
                                            <div style={{ fontSize:13, fontWeight:700, color:"#f0ece0", letterSpacing:"0.04em" }}>
                                                {badge.replace(/_/g, " ")}
                                            </div>
                                            <div style={{ fontSize:10, color:meta.color, letterSpacing:"0.08em", marginTop:2 }}>
                                                {meta.label} tier
                                            </div>
                                        </div>
                                        <div style={{ fontSize:10, color:"#333", letterSpacing:"0.06em" }}>EARNED</div>
                                    </div>
                                );
                            })}
                        </div>
                        ...
                        <div style={S.emptyState}>
                            ...
                            <span style={{ fontSize:13, color:"#333", marginTop:8 }}>Keep reading to earn badges</span>
                        </div>
                    )}
                </div>
                ...
                <div style={S.section}>
                    <div style={S.sectionHead}>
                        ...
                        <button style={S.viewBtn} onClick={() => navigate("/saved")}>View Saved</button>
                    </div>
                </div>
                ...
                <div style={S.section}>
                    ...
                    <div style={{ display:"flex", flexWrap:"wrap", gap:8, marginTop:4 }}>
                        {[...new Set(profile.preferredCategories || [])].map((cat, i) => (
                            <span key={cat} className="chip" style={{ ...S.chip, animationDelay:`${0.05 + i * 0.07}s` }}>
                                {cat}
                            </span>
                        ))}
                    </div>
                ...
                <div style={S.section}>
                    ...
                    <p style={{ fontSize:11, color:"#2e2e2e", letterSpacing:"0.04em", marginBottom:14 }}>
                ...
                <button
                    ...
                    style={{ ...S.actionBtn, color:"#FF6A00", borderColor:"rgba(255,106,0,0.2)", background:"rgba(255,106,0,0.06)", marginBottom:12 }}
...
const S = {
    ...
    email: { color: "#3a3a3a", fontSize: 12, margin: "0 0 14px", letterSpacing: "0.04em" },
    framePill: {
    ...
    frameDot: {
        ...
        background: "#FF6A00", boxShadow: "0 0 8px #FF6A00",
        animation: "glowPulse 2s infinite",
    },
    frameLabel: {
        color: "#FF6A00", fontSize: 11,
    ...
    statLabel: {
        color: "#2e2e2e", fontSize: 8, fontWeight: 600,
    ...
    emptyState: {
        display: "flex", flexDirection: "column", alignItems: "center",
        padding: 24, border: "1px dashed rgba(255,255,255,0.06)",
        borderRadius: 12,
    },

    divider: {
        height: 1, margin: "24px 20px 0",
        background: "linear-gradient(90deg,transparent,rgba(255,106,0,0.12),transparent)",
    },

    chip: {
        background: "rgba(255,255,255,0.03)",
        border: "1px solid rgba(255,255,255,0.08)",
        color: "#555", padding: "7px 15px",
    ...
    activeBadge: {
        ...
        background: "#FF6A00", borderRadius: 4,
    ...
    profileActionBtn: {
        ...
        color: "#FF6A00", fontWeight: 600, fontSize: 13,
        cursor: "pointer", letterSpacing: "0.04em",
        fontFamily: "'DM Sans', sans-serif", transition: "all 0.2s",
    },
};