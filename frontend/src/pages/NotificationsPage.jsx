...
function getMeta(type) {
    return TYPE_META[type] || { icon: "🔔", color: "#FF6A00", label: "Notification" };
}
                ...
                <div style={S.container}>
                    ...
                    <div style={S.filterRow}>
                        {["all", "unread"].map(f => (
                            ...
                            >
                                {f === "all"    && `All  ${notifications.length > 0 ? `(${notifications.length})` : ""}`}
...
const S = {
    ...
    empty: {
        ...
        alignItems: "center", padding: "72px 24px",
        textAlign: "center",
