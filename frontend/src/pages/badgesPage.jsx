...
export default function BadgesPage() {
    ...
    useEffect(() => {
        ...
        axios.get(`${BASE_URL}/api/users/badges`, {
...
const styles = {
    ...
    description: { color: "#999", marginTop: "12px", fontSize: "14px", lineHeight: "1.5" },
...
const popupStyles = {
    ...
    badgeName: { position: "relative", zIndex: 1, color: "#ff9500", marginTop: "12px" },
