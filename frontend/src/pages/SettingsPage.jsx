    ...
    return (
        <>
            ...
            <div style={S.page}>
                    ...
                    {activeTab === "preferences" && (
                        <div style={{ animation:"fadeUp 0.4s ease" }}>
                            ...
                            <div style={S.section}>
                                ...
                                <div style={S.sectionSub}>Choose your preferred reading language</div>
                ...
                {/* ── Toast ── */}
                {saved && (
                    <div style={S.toast}>✓ Settings saved successfully</div>
                )}
            </div>
        </>
    );
...
const S = {
    ...
    toggleLabel: {
        fontSize: "14px", fontWeight: "600", color: "#f0ece0",
    },
    toggleSub: {
        fontSize: "11px", color: "#444", marginTop: "2px",
    },
    toggle: {
    ...
    infoVal: {
        fontSize: "13px", color: "#f0ece0", fontWeight: "600",
        fontFamily: "'Space Grotesk', sans-serif",
    },
    logoutBtn: {
