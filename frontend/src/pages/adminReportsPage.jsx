...
export default function AdminReportsPage() {
    ...
    useEffect(() => {
        ...
        axios.get("http://localhost:8080/api/reports/admin", {
    ...
    async function dismissReport(reportId) {
        const token = localStorage.getItem("token");
        try {
            await axios.delete(`http://localhost:8080/api/reports/admin/${reportId}`, {
                headers: { Authorization: `Bearer ${token}` }
            });
        ...
        <div style={{ background: "#0a0a0a", minHeight: "100vh", fontFamily: "'DM Sans', sans-serif" }}>
            ...
            <div style={{ padding: "24px 16px", maxWidth: "640px", margin: "0 auto" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "24px" }}>
                    ...
                    <div>
                        <h2 style={{
                            color: "#f0ece0", fontFamily: "'Playfair Display', serif",
                ...
                {reports.map(r => (
                    <div key={r.id} style={{
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "12px" }}>
                            <span style={{
                                color: "#e05252", fontWeight: "700", fontSize: "12px",
                        ...
                        <div style={{
                            ...
                            <div style={{ color: "#888", fontSize: "13px" }}>
                                ...
                                <span style={{ color: "#d4af37" }}>#{r.contentId ?? r.articleId}</span>
                            </div>
                            <div style={{ color: "#888", fontSize: "13px" }}>
                                👤 <b style={{ color: "#bbb" }}>User ID:</b> {r.reportedByUserId}
                            </div>
                            <div style={{ color: "#888", fontSize: "13px" }}>
                        ...
                        <div style={{ display: "flex", gap: "8px" }}>
                            <button
                                onClick={() => window.open(`/public/article/${r.contentId}`, '_blank')}
                                style={{
                                    background: "rgba(212,175,55,0.1)",
                                    border: "1px solid rgba(212,175,55,0.2)",
                                    color: "#d4af37", borderRadius: "999px",
