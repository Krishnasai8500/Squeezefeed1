    ...
    return (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
            <circle cx="11" cy="11" r="7"
                stroke={active ? "#FF6A00" : "#555"} strokeWidth="1.8"/>
            <path d="M16.5 16.5L21 21"
                stroke={active ? "#FF6A00" : "#555"} strokeWidth="1.8" strokeLinecap="round"/>
        </svg>
    );
}
...
export default function BottomNav() {
    ...
    useEffect(() => {
        ...
        axios.get(
            `http://localhost:8080/api/notifications/user/${authUserId}/unread`,
    ...
    return (
        <>
            ...
            <div style={S.nav} data-bottomnav>
                ...
                {/* Home */}
                <button className="bnav-btn" style={S.btn}
                    onClick={() => {
                    ...
                    <span style={{ ...S.label, color: active("/") ? "#FF6A00" : "#444" }}>
                        Home
                    </span>
                </button>
                ...
                <button className="bnav-btn" style={S.btn}
                    ...
                    <span style={{ ...S.label, color: active("/search-users") ? "#FF6A00" : "#444" }}>
                        Search
                    </span>
                </button>
                ...
                <button className="bnav-btn" style={S.btn}
                    ...
                    <span style={{ ...S.label, color: active("/notifications") ? "#FF6A00" : "#444" }}>
                        Alerts
                    </span>
                </button>
                ...
                <button className="bnav-btn" style={S.btn}
                    ...
                    <span style={{ ...S.label, color: active("/profile") ? "#FF6A00" : "#444" }}>
                        Profile
                    </span>
                </button>
            </div>
